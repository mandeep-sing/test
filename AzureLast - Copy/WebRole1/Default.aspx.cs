...
namespace WebRole1
{
    public partial class _Default : System.Web.UI.Page, ICallbackEventHandler
    {
        ...
        private void googlesrch(string keyword)
        {
            ...
            // GBaseQuery query = new GBaseQuery(GBaseUriFactory.Default.GetCustomerItemFeedUri("1381722"));
            //GBaseQuery(GBaseUriFactory.Default.GetCustomerItemFeedUri("1381722"))        
            //ttp://base.google.co.uk/base/feeds/items 
                ...
                if (feed.Entries.Count > 0)
                {
                    ...
                    foreach (GBaseEntry entry in feed.Entries)
                    {
                        ...
                        if (entry.GBaseAttributes.Price != null)
                        {
                            ...
                            {
                                dr["name"] = feed.Entries[0].Title.Text.ToString();
                            }                            
                ...
                if (feed.Entries.Count > 0)
                {
                    ...
                    foreach (GBaseEntry entry in feed.Entries)
                    {
                        ...
                        if (entry.GBaseAttributes.Price != null)
                        {
                            ...
                            if (feed.Entries[0].Authors != null)
                            {
                                dr["Merchant"] = feed.Entries[0].Authors[0].Name;
                            }
