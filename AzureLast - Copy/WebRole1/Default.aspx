...
<body>
    ...
    <div>
        <strong>&nbsp;<%--<input type="text"  onkeyup ="return GetProducts(event)" id="txtSearch" name="txtSearch" runat="server" />--%>Keyword:-</strong>
        ...
        <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="true" GroupName="a" 
            oncheckedchanged="RadioButton1_CheckedChanged" Text="Google" />
        <asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="true" 
            GroupName="a" Text="Amazon" oncheckedchanged="RadioButton2_CheckedChanged" />
        <asp:RadioButton ID="RadioButton3" runat="server" AutoPostBack="true" 
            GroupName="a" Text="eBay" oncheckedchanged="RadioButton3_CheckedChanged" />
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label11" runat="server" Visible="False" 
            Text="Select Categories:-" style="font-weight: 700"></asp:Label>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" 
            Text="Search..!" Height="38px" Width="174px" style="font-weight: 700" />
        &nbsp;<div id="results">
        </div>
    </div>
...
&nbsp;
    ...
    <p style="margin-left: 40px">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="name" 
                Height="300px" Width="818px" CellPadding="2" ForeColor="Black" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                     <%--CommandArgument='<%#Eval("UPC1")%>'--%>
                        <asp:LinkButton ID="lbtn1" Text="Select Product"
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False">
        <asp:Label ID="Label15" runat="server" style="font-weight: 700; color: #CC0000" 
            Text="We have following offer for you::"></asp:Label>
    <span class="style1">
        <br />
        <br />
    ...
    <br />
        <br />
    <asp:Label ID="lblamazon" runat="server" 
            style="color: #A55129; text-decoration: underline">Amazon</asp:Label>
    
    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
            CellPadding="3" Width="794px" Height="99px" BackColor="#DEBA84" 
        ...
        <p>
            <asp:Label ID="lblgoogle" runat="server" 
                style="color: #A55129; text-decoration: underline">Google</asp:Label>
        </p>
        <div style="height: 286px; width: 903px; overflow: scroll">
            <asp:GridView ID="grdgoogle" runat="server" AllowSorting="True" 
                AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" 
                BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" 
                Height="271px" onsorting="grdgoogle_Sorting1" Width="884px">
                <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
                <Columns>
                    <asp:BoundField DataField="Title" HeaderText="Title" />
        ...
        <asp:Label ID="lbleBay" runat="server" 
            style="color: #A55129; text-decoration: underline">eBay</asp:Label>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" CellSpacing="2" Height="73px" Width="827px">
            <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
            <Columns>
                <asp:BoundField DataField="Title" HeaderText="Title" />
                <asp:BoundField DataField="Price" HeaderText="Price " />
